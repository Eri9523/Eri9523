Hey there! I'm Sergio Corral, also known as Eri 👋
...
*Always learning and quick to adapt to new technologies*, constantly exploring what's next!

- **Currently building:** Full-stack solutions and automation systems
- **Learning:** AI & Agentic Orchestration, cloud platforms, and blockchain automation
- **Ask me about:** React, Node.js, Python, automation, DevOps, and Smart contract bots
- **Fun facts:**
  - Training AI Pokémon models
  - Loktar Ogar!
  - Fueled by coffee
  - Hacked by my own agentic AI
...
| [**Minimal Event-Driven Architecture (EDA)**](https://github.com/Eri9523/miniEda/blob/develop/README.md) | Asynchronous event-driven architecture using decorators and a central event bus for decoupled business logic. Decorator-based subscription, asyncio concurrency, centralized logging, and no external dependencies. | Python | Architecture |
